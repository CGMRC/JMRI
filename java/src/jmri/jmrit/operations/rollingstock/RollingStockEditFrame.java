...
public abstract class RollingStockEditFrame extends OperationsFrame implements java.beans.PropertyChangeListener {
    ...
    public JButton builtTodayButton = new JButton(Bundle.getMessage("Today"));
    ...
    public void initComponents() {
        ...
        pBuilt.setBorder(BorderFactory.createTitledBorder(Bundle.getMessage("Inspected")));
        addItem(pBuilt, builtTextField, 1, 0);
        addItem(pBuilt, builtTodayButton, 2, 0);
...
//
        ...
        addButtonAction(builtTodayButton);
    ...
    protected void load(RollingStock rs) {
        ...
        String builtDate = rs.getBuilt();
        if (builtDate == null || builtDate.isEmpty()) {
            // format MM/YY from today
            Format f = new SimpleDateFormat("MM/yy");
            builtDate = f.format(new Date());
        }
        builtTextField.setText(builtDate);
    ...
    public void buttonActionPerformed(java.awt.event.ActionEvent ae) {
        ...
        if (ae.getSource() == builtTodayButton) {
            // format MM/YY from today
            Format f = new SimpleDateFormat("MM/yy");
            builtTextField.setText(f.format(new Date()));
            builtTextField.requestFocus();
        }
    }
