...
public class CarsTableFrame extends OperationsFrame implements TableModelListener {
    ...
    JButton filterButton = new JButton(Bundle.getMessage("Filter"));
    JButton saveButton = new JButton(Bundle.getMessage("ButtonSave"));

    JTextField findCarTextBox = new JTextField(6);
    JTextField filterCarTextBox = new JTextField(6);
    ...
    public CarsTableFrame(boolean showAllCars, String locationName, String trackName) {
        ...
        JPanel cp2Filter = new JPanel();
        cp2Filter.setBorder(BorderFactory.createTitledBorder(""));
        //filterButton.setToolTipText(Bundle.getMessage("filterCar"));
        //filterCarTextBox.setToolTipText(Bundle.getMessage("filterCar"));
        cp2Filter.add(filterButton);
        cp2Filter.add(filterCarTextBox);
        cp2.add(cp2Filter);
    ...
    public void buttonActionPerformed(java.awt.event.ActionEvent ae) {
        if (ae.getSource() == filterButton) {
            // TODO
            log.info("Filter pressed: value=" + filterCarTextBox.getText());
            return;
        }
